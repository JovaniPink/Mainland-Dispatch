...
**Scope:** The private 604-record source-lead catalog
...
All 604 current source leads have a valid `source-taxonomy-v1` object and none
uses the `cross-cutting` fallback.

| Primary theme | Records |
| --- | ---: |
| Governance and law | 187 |
| Technology and digital systems | 127 |
| Trade and industry | 77 |
| Economy and finance | 63 |
| Security and geopolitics | 64 |
| Science and health | 25 |
| Society and culture | 29 |
| Environment and resources | 23 |
| Infrastructure and mobility | 8 |
| History and memory | 1 |
| **Total** | **604** |

Geographic scopes are multi-valued, so their counts do not sum to 604. The
current assignments are: mainland China 576, United States 83, global 37, Hong
Kong 23, Asia-Pacific 15, Taiwan 11, Europe 7, Canada 8, Latin America 4,
