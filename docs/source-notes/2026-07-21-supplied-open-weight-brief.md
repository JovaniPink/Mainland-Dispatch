# Supplied Chinese open-weight sourcing brief

**Received:** 2026-07-21

**Source artifact:** `pasted-text.txt` supplied in the Codex task

**SHA-256:** `f0dc29dcff28c09c1943aa5e590cd9a53e9807089a14166ae71fa0929796597a`
**Status:** editorial input; not itself an evidentiary source
...
- [`2026-07-21-chinese-open-models.md`](2026-07-21-chinese-open-models.md)

## Useful additions to revisit

- Anthropic’s claimed export-control and model-redeployment primary record.
- ChinaTalk’s regulatory-capacity discussion.
...
The current package was already saturated with July 2026 AI coverage. The user’s requested next move was older, random material, so this pass does not create more current-cycle AI Dispatch records from the supplied brief. Instead, it creates a separate 2012–2022 backfile sampler across unrelated subjects.

The raw supplied text is not copied into the repository. This note records its identity, intended use, and unresolved follow-ups without representing the brief’s unverified assertions as Mainland Dispatch findings.
