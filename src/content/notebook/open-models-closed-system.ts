...
export const openModelsClosedSystem = parseNotebookEntry({
  ...
  sections: {
    why: [
      ...
      "Episode 191 of Hudson Institute’s China Insider sharpened the contradiction. Miles Yu asks how a politically controlled state can credibly promise an open technology order. His institutional vantage point matters: he directs Hudson’s China Center, which explicitly develops American responses to the “China challenge,” and he previously advised Secretary of State Mike Pompeo. That makes the episode informed strategic commentary, not a neutral transcript of events. The right use for it is to generate questions that can be checked against primary records. The inquiry is not whether a controlled system can produce useful technology—the descriptive answer is yes—but which forms of openness it offers, who governs them, and where their limits appear.",
    ],
    proposal: [
  ...
  unresolvedQuestion:
    "Where will China’s technological openness stop when it conflicts with Party control or strategic advantage—and who will govern the dependencies created before that boundary is reached?",
  limitations: [
